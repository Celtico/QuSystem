...
class QuParametersController extends AbstractController
{


    protected  $qu_admin_service;
    protected  $qu_parameters_model;


    public function indexAction(){
        $this->getQuAdminService();
        $quAdmin = $this->qu_admin_service->getIndex();
        $quAdmin->setQuAdminModelOptions($this->qu_parameters_model);
    ...
    public function getQuAdminService(){
        ...
        $this->qu_parameters_model = $this->getServiceLocator()->get('qu_parameters_model');
        return $this;
    }
