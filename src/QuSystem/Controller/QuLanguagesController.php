...
class QuLanguagesController extends AbstractController
{


    protected  $qu_admin_service;
    protected  $qu_languages_model;


    public function indexAction(){
        $this->getQuAdminService();
        $quAdmin = $this->qu_admin_service->getIndex();
        $quAdmin->setQuAdminModelOptions($this->qu_languages_model);
    ...
    public function getQuAdminService(){
        ...
        $this->qu_languages_model = $this->getServiceLocator()->get('qu_languages_model');
        return $this;
    }
